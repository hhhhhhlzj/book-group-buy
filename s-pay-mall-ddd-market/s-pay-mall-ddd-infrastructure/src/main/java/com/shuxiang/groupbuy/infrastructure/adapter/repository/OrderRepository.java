...
import com.shuxiang.groupbuy.domain.order.adapter.event.PaySuccessMessageEvent;
...
import com.shuxiang.groupbuy.infrastructure.dao.po.PayOrder;
import com.shuxiang.groupbuy.infrastructure.event.EventPublisher;
import com.shuxiang.groupbuy.types.event.BaseEvent;
...
public class OrderRepository implements IOrderRepository {
    ...
    public void doSaveOrder(CreateOrderAggregate orderAggregate) {
        ...
        order.setAddressId(orderAggregate.getAddressId());
        order.setReceiverName(orderAggregate.getReceiverName());
        order.setReceiverPhone(orderAggregate.getReceiverPhone());
        order.setReceiverRegion(orderAggregate.getReceiverRegion());
        order.setReceiverDetail(orderAggregate.getReceiverDetail());
