...
import com.shuxiang.groupbuy.api.IPayService;
...
public class AliPayController implements IPayService {
    ...
    public Response<String> createPayOrder(@RequestBody CreatePayRequestDTO createPayRequestDTO) {
        try {
            ...
            UserAddressEntity address = userCenterService.resolveOrderAddress(userId, createPayRequestDTO.getAddressId());
            if (address == null) {
            ...
            PayOrderEntity payOrderEntity = orderService.createOrder(ShopCartEntity.builder()
                    ...
                    .receiverRegion(address.regionText())
                    .receiverDetail(address.getDetailAddress())
                    .build());
    ...
    /**
     * http://your-domain.example.com/api/v1/alipay/alipay_notify_url
     */
