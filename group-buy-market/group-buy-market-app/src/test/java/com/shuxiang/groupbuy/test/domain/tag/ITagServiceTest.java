package com.shuxiang.groupbuy.test.domain.tag;

import com.shuxiang.groupbuy.domain.tag.service.TagService;
...
public class ITagServiceTest {
    ...
    public void test_get_tag_bitmap() {
        ...
        // 是否存在
        log.info("user001 存在，预期结果为 true，测试结果:{}", bitSet.get(redisService.getIndexFromUserId("user001")));
