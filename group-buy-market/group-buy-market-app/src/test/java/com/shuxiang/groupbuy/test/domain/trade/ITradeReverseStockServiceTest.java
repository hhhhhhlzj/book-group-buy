package com.shuxiang.groupbuy.test.domain.trade;

import com.shuxiang.groupbuy.api.IMarketTradeService;
import com.shuxiang.groupbuy.api.dto.LockMarketPayOrderRequestDTO;
import com.shuxiang.groupbuy.api.dto.LockMarketPayOrderResponseDTO;
import com.shuxiang.groupbuy.api.response.Response;
import com.shuxiang.groupbuy.domain.trade.model.entity.TradeRefundBehaviorEntity;
import com.shuxiang.groupbuy.domain.trade.model.entity.TradeRefundCommandEntity;
import com.shuxiang.groupbuy.domain.trade.service.ITradeRefundOrderService;
...
public class ITradeReverseStockServiceTest {
    ...
    public void test_lockMarketPayOrder() throws InterruptedException {
        ...
        for (int i = 1; i < 4; i++) {
            ...
            lockMarketPayOrderRequestDTO.setUserId("user110" + i);
    ...
    public void test_lockMarketPayOrder_reverse() throws InterruptedException {
        LockMarketPayOrderRequestDTO lockMarketPayOrderRequestDTO = new LockMarketPayOrderRequestDTO();
        lockMarketPayOrderRequestDTO.setUserId("user804");
